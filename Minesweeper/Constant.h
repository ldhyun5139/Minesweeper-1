...
#define NORMAL_GRID_SIZE 35    // 보통 난이도 사각형 크기
#define HARD_GRID_SIZE   30    // 어려움 난이도 사각형 크기

#define EASY_MINE_NUM   (( 9) * ( 9))    // 쉬움 난이도 총 타일 개수
#define NORMAL_MINE_NUM ((16) * (16))    // 보통 난이도 총 타일 개수
#define HARD_MINE_NUM   ((30) * (16))    // 어려움 난이도 총 타일 개수
